...
class GridToggleSnap extends React.Component
{
	constructor( tProps )
	{
		...
		// Events
		this._onSnapToggle = () => { this.props.model.isSnapping = !this.props.model.isSnapping; };
	}
	
	render()
	{
		return (
			<button className={ this.props.model.isSnapping ? "selected" : null } onMouseDown={ this._onSnapToggle }>
