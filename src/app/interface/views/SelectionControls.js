...
class SelectionControls extends React.Component
{
	...
	render()
	{
		const tempIsPanning = this.props.model.isPanning || this.props.model.isPanningHeld;
		...
		return (
			<div className="select-toggle">
				...
				<button className={ this.props.model.isPanning ? null : "selected" } onMouseDown={ this._onPanOff }>
