...
class SelectionControls extends React.Component
{
	constructor( tProps )
	{
		...
		// Events
		this._onPanOn = () => { this.props.model.isPanMode = true; };
		this._onPanOff = () => { this.props.model.isPanMode = false; };
	}
	
	render()
	{
		const tempIsPanning = this.props.model.isPanMode || this.props.model.isPanningHeld;
		...
		return (
			<div className="select-toggle">
				...
				<button className={ this.props.model.isPanMode ? null : "selected" } onMouseDown={ this._onPanOff }>
