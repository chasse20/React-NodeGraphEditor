...
class GridControls extends React.Component
{
	constructor( tProps )
	{
		...
		this._onSnapToggle = () => { this.props.selection.isSnapping = !this.props.selection.isSnapping; };
	}
	...
	render()
	{
		return (
			<div>
				...
				<button className={ this.props.selection.isSnapping ? "selected" : null } onMouseDown={ this._onSnapToggle }>
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="-467 269 24 24">
