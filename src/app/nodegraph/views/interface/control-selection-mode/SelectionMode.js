	...
	render()
	{
		return (
			<div className="select-toggle">
				<button onMouseDown={ this._onPanOn } disabled={ this.props.graph.isPanMode || this.props.graph.isPanning }>
				...
				<button onMouseDown={ this._onPanOff } disabled={ !this.props.graph.isPanMode }>
